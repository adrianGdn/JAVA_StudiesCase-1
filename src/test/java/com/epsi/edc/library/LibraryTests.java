...
public class LibraryTests {	
	 ...
	 */
	@Test
	public void testReturnedAndBorrowBook() throws BookNotFoundException, AllBooksAlreadyReturnedException, UnavailableBookException {
		// Preparation
		...
		assertEquals(errorMessage2, aBooks.getBook(aNewBook.getId()).get(), aBooks.getUserInList(aNewUser.getUsername()).getBook());
	...
	public void testAddGetBook() {
		// Preparation
		Books aBooksPacket = new Books();
		Book aTestBook = new Book("007", "James Bond", "Agent 007", true, "7");
		Book aSecondTestBook = new Book("858585", "Julien Petit", "La VR de demain", true, "10");
	...
	public void testGetBooks() {
		...
		Book aFirstTestBook = new Book("978-0671870362", "Ray Bradbury", "Fahrenheit 451", true, "978");
		Book aSecondTestBook = new Book("978-0671870362", "Ray Bradbury", "Fahrenheit 451", true, "1");
		Book aThirdTestBook = new Book("12345", "Benoît Cavrois", "Life is potatoes", true, "42");
		Book aFourTestBook = new Book("007", "James Bond", "Agent 007", true, "7");
		Book aFiveTestBook = new Book("23232", "I am an author", "I am a title", true, "2323001");
		String errorMessage = "An error has occur when trying to get the book.";
